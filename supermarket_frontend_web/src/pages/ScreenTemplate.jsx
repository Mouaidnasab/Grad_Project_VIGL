...
const TemplateDesigner = () => {
  ...
  useEffect(() => {
    ...
    if (deleteElementBtn)
      deleteElementBtn.addEventListener("click", handleDeleteElement);
    ...
    if (rotateElementBtn)
      rotateElementBtn.addEventListener("click", handleRotateElement);
    ...
    const colorPickerButtons = document.querySelectorAll(
    ...
    const fillPickerButtons = document.querySelectorAll(
      "#fill-picker-container button"
    );
    ...
    const dynamicContentButtons = document.querySelectorAll(
    ...
    if (addBarcodeButton)
      addBarcodeButton.addEventListener("click", handleAddBarcode);

    const handleAddQrCode = () => createElement("qrcode");
    if (addQrCodeButton)
      addQrCodeButton.addEventListener("click", handleAddQrCode);
    ...
    return () => {
      if (generateButton)
        generateButton.removeEventListener("click", handleGenerateButtonClick);
      if (deleteElementBtn)
        deleteElementBtn.removeEventListener("click", handleDeleteElement);
      if (rotateElementBtn)
        rotateElementBtn.removeEventListener("click", handleRotateElement);
      if (alignLeftBtn)
        alignLeftBtn.removeEventListener("click", handleAlignLeft);
      if (alignCenterBtn)
        alignCenterBtn.removeEventListener("click", handleAlignCenter);
      if (alignRightBtn)
        alignRightBtn.removeEventListener("click", handleAlignRight);
      if (alignTopBtn) alignTopBtn.removeEventListener("click", handleAlignTop);
      if (alignMiddleBtn)
        alignMiddleBtn.removeEventListener("click", handleAlignMiddle);
      if (alignBottomBtn)
        alignBottomBtn.removeEventListener("click", handleAlignBottom);
      ...
      if (addTextButton)
        addTextButton.removeEventListener("click", handleAddText);
      if (addBarcodeButton)
        addBarcodeButton.removeEventListener("click", handleAddBarcode);
      if (addQrCodeButton)
        addQrCodeButton.removeEventListener("click", handleAddQrCode);
      if (loadTemplateBtn)
        loadTemplateBtn.removeEventListener("click", loadSelectedTemplate);
    };
  }, [navigate]);
      ...
      <main className="designer-main-content">
        <div className="designer-left-column">
          <div
            ...
            className="justify-content-center align-items-center mb-3 mt-3 d-flex flex-column"
          >
            <div>
